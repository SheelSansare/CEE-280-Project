function [DEFL,REACT,ELE_FOR,AFLAG,APRATIOS] = ud_3dicl(...
...
%UD_3DICL performs a user defined three-dimensional inelastic
...
%                              AFLAG = 2     Elastic Buckling Controls
%                              AFLAG = -2    Solution did not converge
%                              AFLAG = inf   No analysis code available
%       APRATIOS(i,1)    ==  eigenvalue of each mode.  Note modes should be sorted
