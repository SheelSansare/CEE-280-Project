function [DEFL,REACT,ELE_FOR,ELE_YLD,AFLAG,APRATIOS,LIMIT_STATE] = ud_2d1in(...
				nnodes,coord,concen,fixity,nele,ends,A,Izz,Zzz,Ayy,...
				E,v,Fy,YldSurf,Wt,webdir,w,thermal,truss,anatype,sol_scheme,numsteps,...
				ratio_req,stop_ratio,restart,defl,react,ele_for,ele_yld,...
				apratios,limit_state,h_stat_mes)
%UD_2D1IN performs a user defined two-dimensional
