classdef MASTAN2v51App < handle
    ...
    properties (Constant)
        AppPathBase = {'/MASTAN2v51'};
        AppClass = 'MASTAN2v51App';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            MASTAN2v51App.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'MASTAN2v5_1')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong MASTAN2v5_1
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'MASTAN2v5_1').getString, ...
            ...
            if nargout(@MASTAN2v5_1) == 0
                eval('MASTAN2v5_1');
            else
                obj.AppHandle = eval('MASTAN2v5_1');
            end
