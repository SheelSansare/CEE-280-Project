...
analysis = SSLN_Analysis(nnodes,coord,nele,A,Izz,Iyy,J,Ayy,Azz,E,v,webdir,w,ends);
RunAnalysis(analysis, fixity, nnodes, concen);
[AFLAG, DEFL, REACT, ELE_FOR] = GetMastan2Returns(analysis);
